...
class Dummy1
{
	...
	{
		//Online will store the JSON data streamed in string format
		String inline = "";
	
		try
		{
			URL url = new URL("http://albuatweb-278287743.ap-southeast-1.elb.amazonaws.com/web/ExternalService/updateKYCTicketStatus.do");
